...
def calculate_score(cardList):
    ...
    if score == 21 and len(cardList) == 2:
        return 0
...
def winning(user_score, computer_score):
    if user_score == computer_score:
        return "draw"
    elif hasBlackJack(user_score):
        return "BlackJack. You win :)"
    elif hasBlackJack(computer_score):
        return "Computer have the blackJack.You lost :("
    elif computer_score > 21:
        return "Computer have a bust.You win ;)"
    elif user_score > 21:
        return "You have a bust. You lost"
    elif user_score > computer_score:
        return "You win with high score"
    else:
        return "You lost with the lower score"
...
while is_game_playing:
    ...
    if hasBlackJack(user_score) or hasBlackJack(computer_score) or user_score > 21:
...
print(winning(user_score, computer_score))
